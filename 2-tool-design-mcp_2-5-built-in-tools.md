...
[Learn](https://claudecertificationguide.com/learn)/[Tool Design & MCP Integration](https://claudecertificationguide.com/learn/2-tool-design-mcp)/2.5
Domain 2Task 2.5
Mark Complete
# Built-in Tools
...
Mark Complete
[Previous LessonMCP Server Integration](https://claudecertificationguide.com/learn/2-tool-design-mcp/2-4-mcp-server-integration)[Next LessonCLAUDE.md Hierarchy, Scoping, and Modular Organisation](https://claudecertificationguide.com/learn/3-claude-code-config/3-1-claude-md-hierarchy)
