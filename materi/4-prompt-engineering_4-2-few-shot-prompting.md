...
[Learn](https://claudecertificationguide.com/learn)/[Prompt Engineering & Structured Output](https://claudecertificationguide.com/learn/4-prompt-engineering)/4.2
Domain 4Task 4.2
Mark Complete
# Few-Shot Prompting
...
Mark Complete
[Previous LessonSystem Prompts with Explicit Criteria](https://claudecertificationguide.com/learn/4-prompt-engineering/4-1-system-prompts)[Next LessonStructured Output with Tool Use](https://claudecertificationguide.com/learn/4-prompt-engineering/4-3-structured-output)
