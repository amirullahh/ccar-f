...
[Learn](https://claudecertificationguide.com/learn)/[Claude Code Configuration & Workflows](https://claudecertificationguide.com/learn/3-claude-code-config)/3.4
Domain 3Task 3.4
Mark Complete
...
Mark Complete
[Previous LessonPath-Specific Rules for Conditional Convention Loading](https://claudecertificationguide.com/learn/3-claude-code-config/3-3-path-specific-rules)[Next LessonIterative Refinement Techniques](https://claudecertificationguide.com/learn/3-claude-code-config/3-5-iterative-refinement)
