...
[Learn](https://claudecertificationguide.com/learn)/[Agentic Architecture & Orchestration](https://claudecertificationguide.com/learn/1-agentic-architecture)/1.6
Domain 1Task 1.6
Mark Complete
...
Mark Complete
[Previous LessonAgent SDK Hooks](https://claudecertificationguide.com/learn/1-agentic-architecture/1-5-agent-sdk-hooks)[Next LessonSession State and Resumption](https://claudecertificationguide.com/learn/1-agentic-architecture/1-7-session-state-resumption)
