...
[Learn](https://claudecertificationguide.com/learn)/[Claude Code Configuration & Workflows](https://claudecertificationguide.com/learn/3-claude-code-config)/3.1
Domain 3Task 3.1
Mark Complete
...
Mark Complete
[Previous LessonBuilt-in Tools](https://claudecertificationguide.com/learn/2-tool-design-mcp/2-5-built-in-tools)[Next LessonCustom Slash Commands and Skills](https://claudecertificationguide.com/learn/3-claude-code-config/3-2-slash-commands-skills)
