...
[Learn](https://claudecertificationguide.com/learn)/[Claude Code Configuration & Workflows](https://claudecertificationguide.com/learn/3-claude-code-config)/3.2
Domain 3Task 3.2
Mark Complete
...
Mark Complete
[Previous LessonCLAUDE.md Hierarchy, Scoping, and Modular Organisation](https://claudecertificationguide.com/learn/3-claude-code-config/3-1-claude-md-hierarchy)[Next LessonPath-Specific Rules for Conditional Convention Loading](https://claudecertificationguide.com/learn/3-claude-code-config/3-3-path-specific-rules)
